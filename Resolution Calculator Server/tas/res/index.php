...
<b>About</b><br>
This calculator uses the Gaussian approximation for collimator transmission functions and mosaic distributions of the monochromator and analyzer crystals, following the treatment by <a href="http://scripts.iucr.org/cgi-bin/paper?S0365110X67002816">Cooper and Nathans</a>.<br>
Developed by: <a href="http://williamratcliff.com">William Ratcliff</a> at the <a href = "http://www.ncnr.nist.gov/">NIST Center for Neutron Research</a>.
<br>
<b>Collimations</b><br>
...
k:user defined<br>
l:user defined<br>
$\omega$:user defined<br>
$\theta$ correction: multiplicative factor for intensity from structure factor squared for a $\theta$ scan, such that I ~ "$\theta$ correction" x $|F_N|^2$<br>
$\theta$ correction: multiplicative factor for intensity from structure factor squared for a 2$\theta$ scan, such that I ~ "$2\theta$ correction" x $|F_N|^2$<br>
$\theta$ width cross-section (degrees) <br>
$\theta$ width projection (degrees) <br>
$2\theta$ width cross-section (degrees) <br>
$2\theta$ width projection (degrees) <br>
$\omega$ width cross-section (meV) <br>
QX Lab width cross-section (<span>&#8491;</span>) <br>
QY Lab width cross-section (<span>&#8491;</span>) <br>
$\omega$ width projection (meV) <br>
QX Lab width projection (<span>&#8491;</span>) <br>
QY Lab width projection (<span>&#8491;</span>) <br>
QZ width projection (<span>&#8491;</span>) <br>
R$_0$ : scalar resolution prefactor <br>
R$_{CN}$ : resolution 4-vector, which is a function of $\frac{m_n w}{\hbar Q}$, $Q_\parallel$, $Q_\perp$, and $Q_z$ <br>
<b>Graph</b><br>
The purple ellipses represent the cross section of the ellipsoid with a given plane, while peach ellipses show the projection onto the plane.<br>
