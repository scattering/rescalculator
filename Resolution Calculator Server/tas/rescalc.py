...
#        %Sample shape matrix in coordinate system defined by scattering vector
     ...
     def ResPrint(self, H,K,L,W, EXP):
        ...
        #print myrescal.calc_correction(H,K,L,W,EXP,qscan=[[1,0,1],[1,0,1]])
        print self.calc_correction(H,K,L,W,EXP)
        print self.CalcWidths(H,K,L,W,EXP)
        print 'setup length ',len(EXP)
