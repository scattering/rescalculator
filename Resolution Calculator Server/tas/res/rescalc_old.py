...
class rescalculator:
     def __init__(self, mylattice):
          ...
          self.lattice_calculator_procedural2=mylattice
          return
...
#        %Sample shape matrix in coordinate system defined by scattering vector
     ...
     def calc_correction(self,H,K,L,W,EXP,qscan=None):
          ...
          #Q=2*pi*lattice_calculator_procedural2.modvec(H,K,L,'latticestar',mylattice)
          Q=2*pi*lattice_calculator_procedural2.modvec(H,K,L,'latticestar',self.lattice_calculator_procedural2)
          R0,RM=self.ResMat(Q,W,EXP)
          ...
          instrument=lattice_calculator_procedural2.Instrument()
          for ind in range(npts):
          ...
          #x,y,z=self.lattice_calculator_procedural2.StandardSystem()
          #qx,qy,qz,Q=lattice_calculator_procedural2.R2S(H,K,L,mylattice)
          ...
          if qscan != None:
               ...
               for i in range(len(qscan)):
                    ...
                    qscan_mod=self.lattice_calculator_procedural2.modvec(qh,qk,ql,'latticestar')
...
#        print 'yshape ',self.lattice_calculator.y.shape
          ...
          tthwidth_sec=2*2*XBWidthc*N.tan(0.5*S2)/Q
...
def process(a,b,c,alpha,beta,gamma,orient1,orient2,EXP,
    ...
    if table:
        myrescal.ResPrint(H, K, L, W, setup)
    if plot: 
