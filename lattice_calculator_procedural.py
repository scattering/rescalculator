...
def scalar(x1, y1, z1, x2, y2, z2, latticetype,lattice):
     ...
     if latticetype=='latticestar':
          ...
          b=lattice.bstar
          c=lattice.cstar
          alpha=lattice.alphastar
          beta=lattice.betastar
          gamma=lattice.gammastar
...
def angle(self, x1, y1, z1, x2, y2, z2, latticetype,lattice):
     "Calculate the angle between vectors in real and reciprocal space"
...
def modvec(self, x, y, z, latticetype,lattice):
...
def reciprocate(self, x, y, z, latticetype,lattice):
...
def vector(self, x1, y1, z1, x2, y2, z2, latticetype,lattice):
